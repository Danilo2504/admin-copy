...
import { UserPlusIcon, ChartBarIcon } from "@heroicons/react/24/solid";
...
const Home: React.FC<{}> = () => {
  ...
  const renderTopItems: any = [
    {
      title: "Total Users",
      value: isPending ? "..." : data.totalUsers,
      color: "#3490f7",
      icon: UserPlusIcon,
    },
    {
      title: "Active Users",
      value: isPending ? "..." : data?.activeUsers,
      color: "#59e29a",
      icon: ChartBarIcon,
    },
  ];
  ...
  return (
    <main className="grid auto-rows-auto py-4 pl-2 pr-6 gap-6">
      <h1 className="text-[#344767] font-semibold">Dashboard</h1>
      <div className="grid grid-cols-4 gap-6">
        {renderTopItems.map((props: any) => (
          <BasicCard {...props} key={props.title} />
        ))}
      </div>
