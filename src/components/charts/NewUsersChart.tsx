...
const NewUsersChart = () => {
  ...
  const chartData: Record<string, DataProps> = {
    day: {
      title: isLoading ? 'Loading...' : 'Daily New Users',
      report: isRefetching 
      ? generateDailyReport([]) 
      : generateDailyReport(data),
    },
    week: {
      title: isLoading ? 'Loading...' : 'Weekly New Users',
      report: isRefetching 
      ? generateWeeklyReport([])
      : generateWeeklyReport(data)
    },
    month: {
      title: isLoading ? 'Loading...' : 'Monthly New Users',
      report: isRefetching 
  ...
  return (
    <div className='card-base h-min w-full'>
      ...
      <Bar
        data={chartData[interval].report}
